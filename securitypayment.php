...
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://crm.klevrmedia.net/api/leads/$token",
...
$curl = curl_init();
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://crm.klevrmedia.net/api/accountkey",
	CURLOPT_RETURNTRANSFER => true,
	CURLOPT_ENCODING => "",
	CURLOPT_MAXREDIRS => 10,
	CURLOPT_TIMEOUT => 30,
							...
							<div class="row">
								<div class="col-md-12">
									<input type="hidden" id="amount" name="setprice" value="<?php echo $dataLeads->amount; ?>">
										...
										<?php elseif($account_type == 'evalon'):
										?>
											<div class="row">
											<div class="col-md-12">
												<div class="form-group">
											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group">
														...
														<div>
															<label class="text-black" for="EXPIRY">EXPIRY DATE</label>
														</div>
														<!-- <input type="month" id="EXPIRY" name="start"
																	min="2018-03" value="2023-05" class="form-control"> -->
														<div class="">
															<input class="form-control " type="text" name="ssl_exp_date" placeholder="MM / YY" required=""/>
														</div>
													...
													<div class="form-group">
														...
														<div class="">
															<input class="form-control " type="text" name="exp_year" placeholder="YY" minlength="1" maxlength="2" required=""/>
														</div>
