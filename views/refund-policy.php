...
<!-- Mirrored from algosecom.com/refund-policy by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" refundpolicy overflow-hidden" >
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 text-center">
                            <div class="banner-text-inner aboutus-banner-text">
                                <h1 class="fa-90vw font-weight-bold">Refund Policy</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="privacy-terms-refund-text container-1560vw py-100 policyPage" id="sec2">
                    <div class="privacy-policy heading-underline">
                        ...
                        <ul>
                            ...
                            <li>Reasons such as ‘change of mind’, ‘disagreement with partner’, personal reasons or any other reason that do not pertain to the service will not be subject to refund under any circumstances.</li>
