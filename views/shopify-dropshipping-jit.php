...
<!-- Mirrored from algosecom.com/shopify-dropshipping-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:15 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" shopifydropshippingjit overflow-hidden" >
        ...
        <main>
            ...
            <section class="bannerSecInnerPages pt-header text-white section-full-height align-items-center bg-before-linear-gradient bg-image-overlay position-relative extra-padding-orientation sd-banner-jit jit-banner jit-green">
                ...
                <div class="image-item-banner-jit dropshipping-world">
                    <img src="assets/jit/dropshipping/world.png">
                    <div class="dropshipping-jit-parachutes">
                        <img class="image-parachute-jit-left" src="assets/jit/dropshipping/left.png">
                        <img class="image-parachute-jit-center" src="assets/jit/dropshipping/center.png">
                        <img class="image-parachute-jit-right" src="assets/jit/dropshipping/right.png">
                    </div>
                </div>
                <div class="image-jit-banner">
                    <img src="assets/jit/dropshipping/shade.png">
                </div>
            </section>
            ...
            <section class="jit-hwdi bg-image-lines position-relative jit-green">
                <div class="container-1560vw">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                                <h5>How We <span class="gradient-color jit-green-gradent">Do It.</span></h5>
                                <img src="assets/jit/dropshipping/hwdi.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                ...
                <div class="container-1560vw">
                    <div class="row-jit-roadmap six-columns-jit">
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/dropshipping/NicheProductFinalization.png">
                                </div>
                                <h3>Niche/Product <br> Finalization</h3>
                                <ul>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/dropshipping/BrandDevelopment.png">
                                </div>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/dropshipping/ProductSourcing.png">
                                </div>
                                <h3>Supplier <br>Integration</h3>
                                <ul>
                                    <li>Product Listing.</li>
                                    <li>Registration on Supplier Portal.</li>
                                    <li>Supplier App Integration.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/dropshipping/Campaign.png">
                                </div>
                                <h3>Campaign <br>Setup (Up to 2)</h3> 
                                <ul>
                                    <li>Meta Marketing Campaign.</li>
                                    <li>Tiktok Marketing Campaign.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/dropshipping/StoreManagement.png">
                                </div>
            ...
            <section class="services-jit-section jit-green">
                        ...
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>1st Step</span>
                                    <h4>Business <span class="gradient-color jit-green-gradent">Setup</span></h4>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/BusinessSetupBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>2nd Step</span>
                                    <h4>Niche/Product <span class="gradient-color jit-green-gradent">Finalization</span></h4> 
                                    <ul>
                                        <li>Identify Niche Market Segment.</li>
                                        <li>Hunt High Profit Products.</li>
                                        <li>Feasibility Report.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/NicheProductFinalizationBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>3rd Step</span>
                                    <h4>Brand <br><span class="gradient-color jit-green-gradent">Development</span></h4> 
                                    <ul class="column-count-2">
                                        <li>Logo Design.</li>
                                        <li>Website Development.</li>
                                        <li>Social Media Management.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/BrandDevelopmentBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>4th Step</span>
                                    <h4>Supplier <span class="gradient-color jit-green-gradent">Integration</span></h4>
                                    <ul class="column-count-2">
                                        <li>Product Listing.</li>
                                        <li>Registration on Supplier Portal.</li>
                                        <li>Supplier App Integration.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/ProductSourcingBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>5th Step</span>
                                    <h4>Campaign <br><span class="gradient-color jit-green-gradent">Setup (Up to 2)</span></h4>
                                    <ul>
                                        <li>Meta Marketing Campaign.</li>
                                        <li>Tiktok Marketing Campaign.</li>
                                    </ul>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/CampaignBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>6th Step</span>
                                    <h4>Monthly Store <span class="gradient-color jit-green-gradent">Management</span></h4>
                                    <ul class="column-count-2">
                                        <li>Shopify Store Management.</li>
                                        <li>Order Fulfillment.</li>
                                        <li>Return Management.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/dropshipping/StoreManagementBig.png">
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="package-terms-jit package-terms-jit-sd">
                    <h3>Package Terms:</h3>
                    <ul>
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (Algosecom.com)">
                                ...
                                <div class="form-inputs">
                                    <input type="hidden" name="page-name" class="pagename" value="shopifydropshippingjit">
...
<input type="hidden" name="news" value="1">
        ...
        //   $('body').on("click",'.step1',function(){
         $('.form1').on('submit', function (e) {
                ...
                let source= ``;
                let campaign= ``;
                let dat=`/shopify-dropshipping-jit`;
...
<!-- Mirrored from algosecom.com/shopify-dropshipping-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:22 GMT -->
</html>
