...
<!-- Mirrored from algosecom.com/ecommerce-success-stories by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:28 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" ecommercesuccessstories overflow-hidden" >
                ...
                <div class="container-1560vw w-100">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-5 col-sm-4 position-static-mob-screen">
                            <div class="testimonialbanner text-right">
                                <img src="assets/testimonial/testimonial.png">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-on-top container-1560">
                            <form  action="/leads/" method="POST">
                                ...
                                <div class="form-inputs">
                                    <input type="hidden" name="page-name" class="pagename" value="ecommercesuccessstories">
        ...
        //   $('body').on("click",'.step1',function(){
         $('.form1').on('submit', function (e) {
                ...
                let source= ``;
                let campaign= ``;
                let dat=`/ecommerce-success-stories`;
...
<!-- Mirrored from algosecom.com/ecommerce-success-stories by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:30 GMT -->
</html>
