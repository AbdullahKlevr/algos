...
<div class="col-lg-6">
    <img class="hero-lap" src="../assets/home/laptop.webp" alt="">
                ...
                <!--    <img alt="algosecom" src="https://algosecom.com/assets/home/ecomtext.png">-->
                <!--</span>-->
            </section>
            ...
            <!-- <section class="section-4 video-sec image-back position-relative py-150">
                <div class="video-parent layer-top-video container-1560">
                    ...
                    <video controls preload="none" poster="assets/home/videocover.webp">
                      <source src="assets/algosecom.mp4" type="video/mp4">
                    </video>
                </div>
            </section> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mx-auto">
                                <div class="service-box-parent">
                                    <a class="absacnchor" href="amazon-wholesale-fba/"></a>
                                    <span class="innerserrivedesign"></span>
                                    <div class="service-box">
                                        <h4>Amazon Wholesale FBA</h4>
                                        <img alt="algosecom" src="assets/home/amazonfba.png">
                                        <div class="learnmore">
                                            <span>Know More</span>
                                            <span>
                                                <img alt="algosecom" src="assets/arrow-right.svg">
                            ...
                            <!--<div class="col-lg-4 col-md-4 col-sm-6 mx-auto">-->
                            <!--    <div class="service-box-parent">-->
                            <!--        <a class="absacnchor" href="https://algosecom.com/amazon-private-label"></a>-->
                            <!--        <span class="innerserrivedesign"></span>-->
                            <!--        <div class="service-box">-->
                            <!--            <h4>Amazon Private Label</h4>-->
                            <!--            <div class="image-atback">-->
                            <!--                <img alt="algosecom" src="https://algosecom.com/assets/home/amazonlabel.png">-->
                            <!--            </div>-->
                            <!--            <div class="learnmore">-->
                            <!--                <span>Know More</span>-->
                            <!--                <span>-->
                            <!--                    <img alt="algosecom" src="https://algosecom.com/assets/arrow-right.svg">-->
                            <!--                </span>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--    </div>-->
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mx-auto">
                                <div class="service-box-parent">
                                    <a class="absacnchor" href="shopify-dropshipping/"></a>
                                    <span class="innerserrivedesign"></span>
                                    <div class="service-box">
                                        <h4>Shopify Dropshipping</h4>
                                        <img alt="algosecom" src="assets/home/shopifydropshipping.png">
                                        <div class="learnmore">
                                            <span>Know More</span>
                                            <span>
                                                <img alt="algosecom" src="assets/arrow-right.svg">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mx-auto">
                                <div class="service-box-parent active-service-box">
                                    <a class="absacnchor" href="facebook-marketplace/"></a>
                                    <span class="innerserrivedesign"></span>
                                    <div class="service-box">
                                        <h4>Facebook Marketplace</h4>
                                        <img alt="algosecom" src="assets/home/facebookmarketplace.png">
                                        <div class="learnmore">
                                            <span>Know More</span>
                                            <span>
                                                <img alt="algosecom" src="assets/arrow-right.svg">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mx-auto ">
                                <div class="service-box-parent">
                                    <a class="absacnchor" href="virtual-assistants/"></a>
                                    <span class="innerserrivedesign"></span>
                                    <div class="service-box">
                                        <h4>Virtual Assistants</h4>
                                        <img alt="algosecom" src="assets/home/virtualassistant.png">
                                        <div class="learnmore">
                                            <span>Know More</span>
                                            <span>
                                                <img alt="algosecom" src="assets/arrow-right.svg">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-6 ml-sm-0">
                                <div class="service-box-parent">
                                    ...
                                    <div class="service-box">
                                        ...
                                        <img alt="algosecom" src="assets/home/accountrestatement.png">
                                        <div class="learnmore">
                                            <span>Know More</span>
                                            <span>
                                                <img alt="algosecom" src="assets/arrow-right.svg">
                    ...
                    <div class="row align-item-center">
                        ...
                        <div class="col-lg-4 abs-top-image-on-tab">
                            <div class="aspectimage">
                                <img alt="algosecom" src="assets/HS_ALGOSECOM r1-05.png">
                            </div>
                        </div>
                    </div>
                </div>
