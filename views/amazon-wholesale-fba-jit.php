...
<!-- Mirrored from algosecom.com/amazon-wholesale-fba-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:03 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" amazonwholesalefbajit overflow-hidden" >
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 mr-auto">
                            <div class="banner-text-inner aboutus-banner-text jit-banner-text">
                                ...
                                <p class="fa-18vw max-w-600vw mt-26">Get started on your Amazon store! </p>
                            </div>
                        </div>
                    </div>
                    <div class="rated-4-stars">
                        <a href="https://www.trustpilot.com/review/algosecom.com" target="_blank"> 
                            <img src="assets/jit/trustpilot.png">
                            <p>Rated 4 stars by our customer</p>
                        </a>
                    </div>
                </div>
                <div class="image-item-banner-jit">
                    <img src="assets/jit/boxes-awfba.png">
                </div>
                <div class="image-jit-banner">
                    <img src="assets/jit/shade-awfba.png">
                </div>
            </section>
            ...
            <section class="jit-hwdi bg-image-lines position-relative">
                <div class="container-1560vw">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                                <h5>How We <span class="gradient-color">Do It.</span></h5>
                                <img src="assets/jit/hwdi-awfba.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                                <p>We construct successful Amazon stores according to your schedule, eliminating overwhelm while maximizing your sales potential. Our approach focuses on taking one step at a time, providing tailored support precisely when needed through our "Just-in-Time" strategy.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="jit-roadmap">
                <div class="jit-roadmap-heading images-jit-roadmap-sides position-relative text-center">
                    <h6>Roadmap To</h6>
                    <h2>Success</h2>
                </div>
                <div class="container-1560vw">
                    <div class="row-jit-roadmap">
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/jit-icons-awfba/BusinessSetup.png">
                                </div>
                                <h3>Business <br> Setup</h3>
                                <!--<p>Our business setup service tackles the tedious tasks including creating your seller account, scheduling verification calls, and activating it all for you.</p>-->
                                <ul>
                                    <li>Amazon Seller Account Sign Up.</li>
                                    <li>Schedule Amazon Verification Call.</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/jit-icons-awfba/DigitalPresence.png">
                                </div>
                                <h3>Digital <br> Presence</h3>
                                <!--<p>Bring your brand vision to life with eye-catching logo design, seamless website development, secure domain & hosting, professional email setup, and strategically crafted social media profiles.</p>-->
                                <ul>
                                    <li>Logo Design</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/jit-icons-awfba/FirstOrder.png">
                                </div>
                                <h3>First Purchase <br> Order</h3>
                                <!--<p>We navigate the complexities, guiding you through gated/ungated checks, crafting optimized product listings, calculating your ideal inventory budget, and prepping every item for seamless fulfillment.</p>-->
                               <ul>
                                   <li>Gated/UnGated Check</li>
                                   <li>Product Listing</li>
                                   <li>Inventory Budget ($500 Included)</li>
                                   <li>Prep first purchase included</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/jit-icons-awfba/BrandApproval.png">
                                </div>
                                <h3>Brand <br> Approval</h3>
                                <!--<p>We dive deep in conducting thorough market research, identifying winning products, crafting a robust feasibility report, negotiating optimal MOQs & pricing, and securing crucial Letters of Authorization (LOA).</p>-->
                                <ul>
                                    <li>Market Research</li>
                                    <li>Product Hunting</li>
                                    <li>Feasibility Report</li>
                                    <li>MOQ & Pricing Negotiation</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/jit-icons-awfba/StoreManagement.png">
                                </div>
                                <h3>Monthly Store <br> Management</h3>
                                <!--<p>We take care of everything, from managing your Amazon store and fulfilling orders seamlessly to coordinating with prep centers, ensuring policy compliance, handling returns efficiently, and delivering insightful monthly profitability reports.</p>-->
                                <ul>
                                    <li>Amazon Store Management</li>
            ...
            <div class="marquee-jit">
                <h3>Milestones To Achieve</h3>
                <span>.</span>
            </div>
            
            
            <section class="services-jit-section">
                <div class="container-1400vw">
                    <div class="items-jit-services-parent">
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>1st Step</span>
                                    <h4>Business <span class="gradient-color">Setup</span></h4>
                                    <ul>
                                        <li>Amazon Seller Account Sign Up.</li>
                                        <li>Schedule Amazon Verification Call.</li>
                                        <li>Account Activation.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/jit-icons-awfba/BussinessSetupBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>2nd Step</span>
                                    <h4>Digital <span class="gradient-color">Presence</span></h4> 
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/jit-icons-awfba/DigitalPresenceBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>3rd Step</span>
                                    <h4>First Purchase <br><span class="gradient-color">Order</span></h4> 
                                    <ul class="column-count-2">
                                        <li>Gated/UnGated Check</li>
                                        <li>Product Listing</li>
                                        <li>Prep Center Coordination</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/jit-icons-awfba/FirstOrderBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>4th Step</span>
                                    <h4>Brand <span class="gradient-color">Approval</span></h4> 
                                    <ul class="column-count-2">
                                        <li>Market Research</li>
                                        <li>Product Hunting</li>
                                        <li>Feasibility Report</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/jit-icons-awfba/BrandApprovalBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>5th Step</span>
                                    <h4>Monthly Store <span class="gradient-color">Management</span></h4> 
                                    <ul class="column-count-2">
                                        <li>Amazon Store Management</li>
                                        <li>Order Fulfillment</li>
                                        <li>Prep Center Coordination</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/jit-icons-awfba/StoreManagemenBig.png">
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="package-terms-jit">
                    <h3>Package Terms:</h3>
                    <ul>
                        <li>100% Profit Ownership</li>
                    ...
                    <ul>
                        ...
                        <li>In case of Account deactivation agency will create a new account without any charges and agency will cover document registration cost.</li>
                    </ul>
                </div>
            </section>
...
<input type="hidden" name="news" value="1">
        ...
        //   $('body').on("click",'.step1',function(){
         $('.form1').on('submit', function (e) {
                ...
                let source= ``;
                let campaign= ``;
                let dat=`/amazon-wholesale-fba-jit`;
...
<!-- Mirrored from algosecom.com/amazon-wholesale-fba-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:09 GMT -->
</html>
