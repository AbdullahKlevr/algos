...
<!-- Mirrored from algosecom.com/amazon-private-label-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" amazonprivatelabeljit overflow-hidden" >
        ...
        <main>
            ...
            <section class="bannerSecInnerPages pt-header text-white section-full-height align-items-center bg-before-linear-gradient bg-image-overlay position-relative extra-padding-orientation jit-banner">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 mr-auto">
                            <div class="banner-text-inner aboutus-banner-text jit-banner-text">
                                ...
                                <h1 class="fa-75vw font-weight-bold line-height-85vw">Amazon <br><span class="gradient-color">Private Label</span></h1>
                                <p class="fa-18vw max-w-600vw mt-26">Set up your own Amazon Private Label without having to undergo the strenuous and overwhelming process. We guide you from start to finish, optimizing every move for maximum efficiency.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="image-item-banner-jit apl-jit-image">
                    <img src="assets/jit/apl/bannerimg.png">
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                                ...
                                <img src="assets/jit/apl/hwdi.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hwdi-jit-text-image">
                ...
                <div class="container-1560vw">
                    <div class="row-jit-roadmap seven-columns-jit">
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/MarketProduct.png">
                                </div>
                                <h3>Market/Product <br> Finalization</h3>
                                <ul>
                                    <li>Identify Niche Market Segment.</li>
                                    <li>Hunt High Profit Products.</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/Branding.png">
                                </div>
                                <h3>Brand<br> Development</h3> 
                               <ul>
                                   <li>Logo Design</li>
                                    ...
                                    <li>Amazon Store Front Design</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/Documentation.png">
                                </div>
                                <h3>Product <br>Sourcing</h3> 
                                <ul>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/Video.png">
                                </div>
                                <h3>Product <br>Shoot/Video</h3>
                                <ul>
                                    <li>Video Shoot</li>
                                    <li>Product Photography</li>
                                    <li>Animations & Editing</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/MarketingCampaignBig.png">
                                </div>
                                <h3>Marketing <br>Campaign</h3>
                                <ul>
                                    <li>Amazon PPC Campaign</li>
                        ...
                        <div class="col-jit-roadmap">
                            <div class="item-jit-roadmap">
                                <div class="image-icon-jit-roadmap">
                                    <img src="assets/jit/apl/MarketResearch.png">
                                </div>
                        ...
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/BussinessSetupBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>2nd Step</span>
                                    <h4>Market/Product <span class="gradient-color">Finalization</span></h4> 
                                    <ul>
                                        <li>Identify Niche Market Segment.</li>
                                        <li>Hunt High Profit Products.</li>
                                        <li>Feasibility Report.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/MarketProductBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>3rd Step</span>
                                    <h4>Brand <br><span class="gradient-color">Development</span></h4> 
                                    <ul class="column-count-2">
                                        <li>Logo Design</li>
                                        <li>Website Development</li>
                                        <li>Domain & Hosting</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/BrandingBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>4th Step</span>
                                    <h4>Product<span class="gradient-color"> Sourcing</span></h4>  
                                    <ul class="column-count-2">
                                        <li>MOQ & Pricing Negotiation.</li>
                                        <li>Inventory Testing & Inspection.</li>
                                        <li>Inventory Purchase Order.</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/DocumentationBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>5th Step</span>
                                    <h4>Product <span class="gradient-color">Shoot/Video</span></h4>
                                    <ul>
                                        <li>Video Shoot</li>
                                        <li>Product Photography</li>
                                        <li>Animations & Editing</li>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/VideoBig.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                <div class="services-jit-column-text">
                                    <span>6th Step</span>
                                    <h4>Marketing <span class="gradient-color">Campaign</span></h4>
                                    <ul>
                                        <li>Amazon PPC Campaign</li>
                                        <li>Affiliate Marketing Campaign</li>
                                    </ul>
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/MarketingCampaign.png">
                                </div>
                            </div>
                        </div>
                        <div class="services-jit-main-item">
                            <div class="services-jit-main-row">
                                ...
                                <div class="services-jit-column-image">
                                    <img src="assets/jit/apl/MarketResearchBig.png">
                                </div>
                            </div>
                        </div>
                    </div>
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (Algosecom.com)">
                                ...
                                <div class="form-inputs">
                                    <input type="hidden" name="page-name" class="pagename" value="amazonprivatelabeljit">
...
<input type="hidden" name="news" value="1">
        ...
        //   $('body').on("click",'.step1',function(){
         $('.form1').on('submit', function (e) {
                ...
                let source= ``;
                let campaign= ``;
                let dat=`/amazon-private-label-jit`;
...
<!-- Mirrored from algosecom.com/amazon-private-label-jit by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:58:15 GMT -->
</html>
