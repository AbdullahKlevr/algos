...
<!-- Mirrored from algosecom.com/shopify-dropshipping by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:57:28 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php include_once("includes/head.php") ?>

<body class=" shopifydropshipping overflow-hidden" >
            ...
            <section class="bannerSecInnerPages pt-header text-white section-full-height align-items-center bg-before-linear-gradient bg-image-overlay position-relative">
                <div class="container-1560vw w-100">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-5 col-sm-5 position-static-mob-screen">
                            <div class="shopifybanner sm-mob-bg-image">
                                <img class="shopify-main" src="assets/services/shopifydropshipping/bannerbg.png">
                                <img class="shopify-boxes" src="assets/services/shopifydropshipping/bannerboxes.png">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="our-philosophy py-100 bg-image-lines bigger-image-before position-relative pb-0">
    <div class="container-1560">
        ...
        <div class="max-w-1150 mb-100">
            ...
            <section class="services-we-provide position-relative shopify-services-section no-animations">
                ...
                <div class="service-container-parent margin-service-container revert-column">
                    <div class="container-1560">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="image-container-service img-blur-bottom">
                                    <span class="circle-behind-image"></span>
                                    <img src="assets/services/shopifydropshipping/ecommerce.png">
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="image-container-service">
                                    <span class="circle-behind-image"></span>
                                    <img src="assets/services/shopifydropshipping/nicheanalysis.png">
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="container-1560">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="image-container-service">
                                    <span class="circle-behind-image"></span>
                                    <img src="assets/services/shopifydropshipping/productresearch.png">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="max-w-625 mr-auto text-container-text ">
                ...
                <div class="service-container-parent margin-service-container ">
                    <div class="container-1560">
                        ...
                        <div class="col-lg-6">
                            <div class="image-container-service">
                                <span class="circle-behind-image"></span>
                                <img src="assets/services/shopifydropshipping/supplierresearch.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="max-w-625 ml-auto text-container-text">
                    ...
                    <div class="container-1560">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="image-container-service">
                                    <span class="circle-behind-image"></span>
                                    <img src="assets/services/shopifydropshipping/digitalmarketing-big.png">
                                    <img class="smallimage-animation shopifydm" src="assets/services/shopifydropshipping/digitalmarketing-small.png">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="max-w-625 mr-auto text-container-text ">
                ...
                <div class="service-container-parent margin-service-container ">
                    <div class="container-1560">
                        ...
                        <div class="col-lg-6">
                            <div class="image-container-service">
                                <span class="circle-behind-image"></span>
                                <img src="assets/services/shopifydropshipping/storemangement.png">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="max-w-625 ml-auto text-container-text">
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (Algosecom.com)">
                                ...
                                <div class="form-inputs">
                                    <input type="hidden" name="page-name" class="pagename" value="shopifydropshipping">
...
<!-- Mirrored from algosecom.com/shopify-dropshipping by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:57:31 GMT -->
</html>
