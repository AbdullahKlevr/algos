...
<!-- Mirrored from algosecom.com/how-to-make-passive-income-on-amazon by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Feb 2024 20:59:58 GMT -->
...
<input type="hidden" name="news" value="1">
        ...
        //   $('body').on("click",'.step1',function(){
         $('.form1').on('submit', function (e) {
                ...
                let source= ``;
                let campaign= ``;
                let dat=`/how-to-make-passive-income-on-amazon`;
